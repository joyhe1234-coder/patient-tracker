...
describe('emailService - SMTP Configuration', () => {
  ...
  // REMOVED (ln-630 audit B12.2): 'Email content requirements' (2 tests) and
  // 'Admin password reset notification content requirements' (4 tests) — self-referential
  // assertions on local string constants that never call emailService functions.
  // REMOVED: 'Admin password reset notification URL construction' (2 tests) — tests a local
  // function that duplicates but doesn't import the real URL construction logic.
});
