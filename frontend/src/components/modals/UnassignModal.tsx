        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Unassign Patients</h3>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-md p-3 mb-4 flex items-start gap-2">
            ...
            <p className="text-sm text-amber-800">
              Unassigned patients will not appear in any physician's view until reassigned.
            </p>
          </div>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              className="px-4 py-2 text-sm font-medium text-white bg-amber-600 rounded-md hover:bg-amber-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {loading && (
